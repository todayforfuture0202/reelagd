...
(function(a){
    a.fn.number_slideshow=function(p){
        ...
        var button_current_text_color=p&&p.slideshow_button_current_text_color?p.slideshow_button_current_text_color:"none";
        ...
        var s_l_g=p&&p.slideshow_loading_gif?p.slideshow_loading_gif:"/images/_loading.gif";
        var first = false;
        r += "px";
        s += "px";
        t += "px";
...
/* ysk 기본설정 */
            ...
            $(function() {
                $("#number_slideshow").number_slideshow({
                    ...
                    slideshow_window_width: '900', // ysk 가로값
                    slideshow_window_height: '470', // ysk 세로값
                    ...
                    slideshow_loading_gif: '/images/_loading.gif',
