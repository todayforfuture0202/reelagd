...
<!-- 메인 -->
<div id="wrap" style="width: 1900px !important;">
    <div id="header_wrap">
        <div class="header_box">
			...
			<table style="width: 100%">
				<tr><td>
					...
					<div class="login" style="margin-right: 310px; display: flex;">
								...
								<li id="sign-in-submit">
									<?php if(!Session::has('user_session')) { ?>
										<a href="javascript:showLoginForm();" >
											<img src="images/login_login.png?v01">
										</a>
									<?php } ?>                        
								</li>
								<li>
									<?php if(!Session::has('user_session')) { ?>
										<a href="javascript:showRegisterForm();" >
											<img src="images/login_join.png?v01">
										</a>
									<?php } else {?> 
...
<!--<div id="footer"><img src="images/footer.png"></div>--><!-- footer -->
		...
		<script type="text/javascript">
			...
			<?php } else {?>
				...
				function onDownloadPC() {
					document.location.href = "http://103.1.251.127:81/ReelBoxSetup.exe";
				}

				function onDownloadMobile() {
					document.location.href = "http://103.1.251.127:81/ReelBox.apk";
				}
...
<?php /**PATH E:\xampp\htdocs\reel\resources\views/user.blade.php ENDPATH**/ ?>