...
<link href="css/bootstrap.min.css" rel="stylesheet" type="text/css">
	...
	<meta name="application-name" content="ReelZzang" />
...
.mobile-download {
	background: url("m/images/모바일다운.png?v04");
	background-size: 100%;
...
.login_div {
	background: url("m/images/bg_btn_gray.png?v04");
	background-size: 100%;
	background-repeat: no-repeat;
	width: 130px; 
	height: 30px; 
...
.register_div {
	background: url("m/images/bg_btn_goldencastle.png?v04");
	background-size: 100%;
	background-repeat: no-repeat;
	width: 130px; 
	height: 30px; 
...
<!-- End Google Tag Manager (noscript) -->	
	<div class="container" style="padding: 0; text-align: center;">
		...
		<header class="header-global bg-offset-adjust" style="display: none;">
	...
	<div class="nav-fixed">
		<a class="nav-trigger" href="#" title="menu" data-target="html" data-css-class="menu"  style="display: none;">Menu</a>
		<span class="button bg-magenta-dark project-inquiry hide-for-smaller">환영합니다 !!</span>
	</div>
	
	<nav class="nav-global-hidden" style="display: none;">
	...
	<div style="margin-top: 252px;">
		...
		<?php } else {?> 
			<div class="register_div" onclick="onDownloadMobile()">
				다운로드
			</div>
			<div class="login_div">
...
--><?php /**PATH C:\xampp\htdocs\reel\resources\views/mobile/user.blade.php ENDPATH**/ ?>