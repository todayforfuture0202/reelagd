...
.mobile-download {
	background: url("m/images/mobile.png?v04");
	background-size: 100%;
...
.mobile-download:hover {
	background: url("m/images/mobile_click.png?v04");
	background-size: 100%;
	background-repeat: no-repeat;
}

.login_div {
	background: url("m/images/login_before.png?v04");
	background-size: 100%;
	background-repeat: no-repeat;
	width: 113px; 
	height: 127px; 
...
.login_div:hover {
	background: url("m/images/login_after.png?v04");
	background-size: 100%;
	background-repeat: no-repeat;
}

.register_div {
	background: url("m/images/register_before.png?v04");
	background-size: 100%;
	background-repeat: no-repeat;
	width: 113px; 
	height: 127px; 
...
.register_div:hover {
	background: url("m/images/register_after.png?v04");
	background-size: 100%;
	background-repeat: no-repeat;
}
</style>		
...
<!-- End Google Tag Manager (noscript) -->	
	...
	<script type="text/javascript">
			...
			<?php } else {?>
				...
				function onDownloadPC() {
					document.location.href = "http://210.180.118.22:81/ReelZangSetup.exe";
				}

				function onDownloadMobile() {
					document.location.href = "http://210.180.118.22:81/ReelZang.apk";
				}
...
--><?php /**PATH D:\ReelGame\WebDownload\resources\views/mobile/user.blade.php ENDPATH**/ ?>